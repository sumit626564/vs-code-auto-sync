...
// let costs = [300,2000,400,700,150,600]

// // ! filter() : to filter the array elements based upon the condition
// let filteredArr = costs.filter((element,i)=>{
//     if(element>=500){
//         return element
//     }
// })
// console.log(filteredArr);  // [2000, 700, 600]

// // ! map() : to map each array element
// let mappedArr = http://filteredArr.map((c,i)=>{
//     return c+100
// })
// console.log(mappedArr);  // [2100, 800, 700]

// // ! reduce() : reduce entire array into single value
// let total = mappedArr.reduce(function(result,value){ 
//     return result+value
// },1000)
// console.log(total);

// let std = [123,"mailto:ram","5676566789","ram123@gmail.com"]
// password -- first 4 letters of mail id and last 4 digits of contact num
// ram16789 