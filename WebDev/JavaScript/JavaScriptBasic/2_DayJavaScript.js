...
// console.log(5<10 && 400>=100 && 4<=10);

// // || -- true -- if any one condition is true
// console.log(2>=90 || 80<=10 || 40>=80 || 1<2);
...
// let age = 2
// let res = (age>=18) ? console.log('You are eligible to vote') : console.log('You are not eligible');
...
// let bill = Number(prompt('Enter the bill amount'))  //700
...
// else if(bill>=10001){
//     let dis = 10/100*bill;
//     alert(`Dear customer your payable amount is ${bill-dis} with discount of ${dis}`);
// }
// else{
...
// ! looping stmts -- initialization, condition, updation
